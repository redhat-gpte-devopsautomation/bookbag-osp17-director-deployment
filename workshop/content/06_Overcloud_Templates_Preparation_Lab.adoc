...
. Create ~/templates directory for the environment files and Heat templates:
+
[source,sh]
----
...
. Copy the TripleO Heat template's roles_data.yaml to home/stack/templates/:
+
[source,sh]
----
